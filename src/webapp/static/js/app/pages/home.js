...
function setupInfiniteScroll(container) {
    ...
    // делаем прокрутку по САМОМУ контейнеру, а не по окну
    ...
    const onScroll = () => {
        ...
        if (st + ch >= sh - threshold) loadMore(container, true);
    };

    // снять прошлый, если был, и навесить новый
    container.removeEventListener("scroll", container._infH || (() => {}));
    container._infH = onScroll;
